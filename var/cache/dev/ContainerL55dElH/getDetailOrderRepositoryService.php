 ...
 */
class getDetailOrderRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DetailOrderRepository' shared autowired service.
     *
     * @return \App\Repository\DetailOrderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DetailOrderRepository.php';

        return $container->privates['App\\Repository\\DetailOrderRepository'] = new \App\Repository\DetailOrderRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
