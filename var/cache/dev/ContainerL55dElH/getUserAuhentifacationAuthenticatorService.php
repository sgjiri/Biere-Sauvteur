 ...
 */
class getUserAuhentifacationAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\UserAuhentifacationAuthenticator' shared autowired service.
     *
     * @return \App\Security\UserAuhentifacationAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'UserAuhentifacationAuthenticator.php';

        return $container->privates['App\\Security\\UserAuhentifacationAuthenticator'] = new \App\Security\UserAuhentifacationAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
